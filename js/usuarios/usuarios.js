$(document).ready(function(){
	...
	$('.btn-exit-system').on('click', function(){
		swal({
		  	title: 'Estas seguro?',
		  	text: "Estas cerrado la sesion",
		  	type: 'warning',
		  	showCancelButton: true,
		  	confirmButtonColor: '#03A9F4',
		  	cancelButtonColor: '#F44336',
		  	confirmButtonText: '<i class="glyphicon glyphicon-ok-circle"></i> Si, Salir!',
		  	cancelButtonText:  '<i class="glyphicon glyphicon-remove-circle"></i> No!'
		}).then(function () {
